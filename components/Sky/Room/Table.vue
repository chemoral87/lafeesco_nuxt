<template>
    <div>
        <v-data-table dense mobile-breakpoint="0" @update:sort-by="sortTable" :must-sort="true" :headers="headers"
            :items="items" :options.sync="optionsTable" :server-items-length="total" class="elevation-1 xwidth1200">
        ...
        <DialogDelete v-if="dialogDelete" :dialog="dialogDeleteProp" @ok="(item) => {
                $emit('delete', item);
            }
            " @close="$emit('update:dialogDelete', false)"></DialogDelete>
    </div>
</template>
<script>
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: "min_age", value: "min_age", sortable: true, firstSortDesc: true },
                { text: "max_age", value: "max_age", sortable: true, firstSortDesc: true },
                { text: "active", value: "active", sortable: true, firstSortDesc: true },
