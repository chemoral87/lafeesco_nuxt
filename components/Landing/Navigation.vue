<template>
  <div>
    <v-navigation-drawer v-model="drawer" app temporary dark src="/img/bgdrawer-min.png">
      <v-list>
        <v-list-item>
          <v-list-item-avatar>
      ...
      <v-list dense>
        <v-list-item v-for="([icon, text, link, route], i) in items" :key="i" link @click="fireItem(link, route)">
